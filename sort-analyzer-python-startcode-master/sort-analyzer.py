...
def main():
    ...
    while loop:
        ...
        if (selection == "1"):
            ...
            startTime = time.time()
            sorting_functions.bubbleSort(randomData)
            endTime = time.time()
 
            timeToDoStuff = endTime - startTime
            print("Time: ", (timeToDoStuff))

        elif (selection == "2"):
            print("\nBubble Sort Reversed Data")
            startTime = time.time()
            sorting_functions.bubbleSort(reversedData)
            endTime = time.time()
            ...
            startTime = time.time()
            sorting_functions.bubbleSort(fewUniqueData)
            endTime = time.time()
            ...
            startTime = time.time()
            sorting_functions.bubbleSort(nearlySortedData)
            endTime = time.time()
            ...
            startTime = time.time()
            sorting_functions.selectionSort(randomData)
            endTime = time.time()
            ...
            startTime = time.time()
            sorting_functions.selectionSort(reversedData)
            endTime = time.time()
            ...
            startTime = time.time()
            sorting_functions.selectionSort(fewUniqueData)
            endTime = time.time()
            ...
            startTime = time.time()
            sorting_functions.selectionSort(nearlySortedData)
            endTime = time.time()
            ...
            startTime = time.time()
            sorting_functions.insertionSort(randomData)
            endTime = time.time()
            ...
            startTime = time.time()
            sorting_functions.insertionSort(reversedData)
            endTime = time.time()
            ...
            startTime = time.time()
            sorting_functions.insertionSort(fewUniqueData)
            endTime = time.time()
            ...
            startTime = time.time()
            sorting_functions.insertionSort(nearlySortedData)
            endTime = time.time()
